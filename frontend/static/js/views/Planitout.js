...
async getHtml() {
    ...
    <section id="Plan-it-out">
        ...
        <div>
            ...
            <a class="menuLink" href = "" id="sunMeal"></a>
        </div>
        <div>
            <div class="menuDay">Monday's Menu: </div>
            <a class="menuLink" href = "" id="monMeal"></a>
        </div>
        <div>
            <div class="menuDay">Tuesday's Menu: </div>
            <a class="menuLink" href = "" id="tuesMeal"></a>
        </div>
        <div>
            <div class="menuDay">Wednesday's Menu: </div>
            <a class="menuLink" href = "" id="wedMeal"></a>
        </div>
        <div>
            <div class="menuDay">Thursday's Menu: </div>
            <a class="menuLink" href = "" id="thursMeal"></a>
        </div>
        <div>
            <div class="menuDay">Friday's Menu: </div>
            <a class="menuLink" href = "" id="friMeal"></a>
        </div>
        <div>
            <div class="menuDay">Saturday's Menu: </div>
            <a class="menuLink" href = "" id="satMeal"></a>
        </div>
            </div>
